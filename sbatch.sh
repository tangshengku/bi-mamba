...
python teacher.py  --tag mamba2_780m --model_size 780M  --train_data_dir data/Slimpajama --use_kd 1 --n_nodes 1 --n_devices_per_node 8 --per_device_batch_size 4 --w_bits 1 --accumulate_grad_batches 8